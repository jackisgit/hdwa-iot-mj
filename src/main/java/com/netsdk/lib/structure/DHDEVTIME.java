...
public class DHDEVTIME extends NetSDKLib.SdkStructure {
    ...
    */
    ...
    public int getHour() {
        return getAnd(date, 6 + 6, 6 + 6 + 5);
    }

    public int getDay() {
        return getAnd(date, 6 + 6 + 5, 6 + 6 + 5 + 5);
    }

    public int getMonth() {
        return getAnd(date, 6 + 6 + 5 + 5, 6 + 6 + 5 + 5 + 4);
    }

    public int getYear() {
        return 2000 + getAnd(date, 6 + 6 + 5 + 5 + 4, 6 + 6 + 5 + 5 + 4 + 6);
    }
    ...
    public int getOriginalYear() {
        return getAnd(date, 6 + 6 + 5 + 5 + 4, 6 + 6 + 5 + 5 + 4 + 6);
    }
