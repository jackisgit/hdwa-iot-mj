...
public enum EM_NEW_CONFIG {
    ...
    CFG_CMD_VSP_GAYS("VSP_GAYS"), // 接入配置(CFG_VSP_GAYS_INFO)
    ...
    CFG_CMD_VSP_SCYDKD("VSP_SCYDKD"), // 接入配置(对应 CFG_VSP_SCYDKD_INFO)
    ...
    CFG_CMD_NETNVR_ENCRYPT("NvrEncrypt"), // 配置信息，涉及IPC和NVR(
